/* Morales Rosales Iván A
   1231098
   P4 Sección de memoria (prueba de memoria RAM)
   uPuC */
...
const unsigned int offset = 0x2200; 
unsigned int  var = 0;
...
int main(void)
{
	while(1){
		...
		getchar();
		puts("\nDireccion Inicial 0x7000\n\r");
		printAddressBusTest(addressBusTest(segment,0x7000)); 
	
		getchar();
		puts("\nDireccion Espejo 0x5000\n\r");
		printAddressBusTest(addressBusTest(segment,0x5000)); 
		
		getchar();
		puts("\nDireccion Invalida 0x6000\n\r");
		printAddressBusTest(addressBusTest(segment,0x6000)); 
		
		getchar();
		puts("\nDireccion Invalida 0x9000\n\r");
		printAddressBusTest(addressBusTest(segment,0x9000)); 
